...
output_path = os.path.join(data_dir, 'partb-2012-2016-raw.csv.gz')

# Note - CMS has changed the names of columns over the years
# We'll normalize column names for each year, concat all, and save
